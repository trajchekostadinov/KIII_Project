...
#📌 Забелешки
-Не се чуваат податоци за картички (Stripe го прави тоа)
-Апликацијата е наменета како MVP / демо систем
-За production потребни се дополнителни безбедносни мерки
